...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * | Shift|   `  |   Z  |   X  |   C  |   V  |   [  |   ]  |   B  |   N  |   M  |   ,  |   .  |   /  |
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * |Adjust|   \  | Alt  | GUI  | EISU |Lower |Space |Space |Raise | KANA | Left |Right | Down | Up   |
   * `-------------------------------------------------------------------------------------------------'
   */
  [_QWERTY] = LAYOUT( \
      ...
      ADJUST,  KC_ESC,  KC_LALT, KC_LGUI, EISU,    LOWER,   KC_SPC,  KC_SPC,  RAISE,   KANA,    KC_LEFT, KC_RIGHT,KC_DOWN, KC_UP    \
      ),
