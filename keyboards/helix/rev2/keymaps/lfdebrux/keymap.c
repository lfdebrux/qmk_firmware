...
//Layer taps
#define LT_L LT(_LOWER, KC_SPC)
#define LT_R LT(_RAISE, KC_SPC)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * | Shift|   `  |   Z  |   X  |   C  |   V  |   [  |   ]  |   B  |   N  |   M  |   ,  |   .  |   /  |
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * |Adjust|   \  | Ctrl | Alt  | GUI  |Lower |Space |Space |Raise | GUI  | Left |Right | Down | Up   |
   * `-------------------------------------------------------------------------------------------------'
   */
  [_QWERTY] = LAYOUT( \
      ...
      ADJUST,  KC_ESC,  _______, KC_LALT, KC_LGUI, LT_L,    KC_SPC,  KC_SPC,  LT_R,    KC_RGUI, KC_LEFT, KC_RIGHT,KC_DOWN, KC_UP    \
      ),
  ...
  [_LOWER] = LAYOUT( \
      ...
      KC_CAPS, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_LPRN, KC_RPRN, KC_F12,  _______, _______, KC_HOME, KC_END,  KC_PIPE, \
